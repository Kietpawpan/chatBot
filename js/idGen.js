function myFunction() {
  ...
  window.alert(document.getElementById("idGen").innerHTML = "รหัสคำขอของ คุณ" + text + " " + text2 + " " + "คือ " + f + s + yz + mz + dd + h + " " + "ออกโดย " + officer + " เมื่อวันที่ " + dd + " " + mx + " พ.ศ. " + yyyy + " เวลา " + hh + " : " + min + " น.");
}